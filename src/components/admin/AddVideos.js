...
const pushData = async ()=>{
    await app.firestore().collection("videos").add({
        image: image, 
        program: event,
    ...
    <NavName>Add Videos</NavName>
        ...
        <Upload htmlFor="pix">Upload Video</Upload>
        <input type="file" id="pix" accept="video/mp4" style={{display: "none"}} onChange={upload}/>
